...
function ColorPickerRootImpl(props: ColorPickerRootImplProps) {
  ...
  const onPopoverOpenChange = React.useCallback(
    // @ts-ignore fallback to basic typing
    (open: boolean, eventDetails?: unknown) => {
      store.setOpen(open)
      // @ts-ignore
      onOpenChange?.(open)
    },
...
interface ColorPickerTriggerProps
  extends Omit<React.ComponentProps<typeof PopoverTrigger>, "render" | "className"> { asChild?: boolean; className?: string; children?: React.ReactNode; }
...
function ColorPickerTrigger(props: ColorPickerTriggerProps) {
  ...
  return (
    <PopoverTrigger
      render={<TriggerPrimitive data-slot="color-picker-trigger" />}
...
interface ColorPickerContentProps
  extends Omit<React.ComponentProps<typeof PopoverContent>, "className" | "render"> { asChild?: boolean; className?: string; children?: React.ReactNode; }
